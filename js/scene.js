...
export function create_geometry(scene) {
  ...
  loader1.load(
    ...
    function (gltf) {
      ...
      gltf.scene.position.y = - 0.100;
      gltf.scene.position.x = +0.018;
      //   gltf.scene.position.z = -0.5;
      gltf.scene.rotation.x = Math.PI / -10;
      gltf.scene.rotation.y = Math.PI  - 0.0100;      //   gltf.scene.rotation.z = 80;
...
export function create_Intro(scene) {
  ...
  var text = dcText("Aneitung", 2, 2, 50, 0x000000, 0xcccccc);
  text.position.set(0, 14, -50);
  textGroup.add(text);
  var text1 = dcText("Es kommen mehrere Objekte auf dich zu.", 2, 2, 50, 0x000000, 0xcccccc);
  text1.position.set(0, 10, -50);
  textGroup.add(text1);
  var text2 = dcText("Wenn dich eine Kugel trifft, verlierst du ein Leben.", 2, 2, 50, 0x000000, 0xcccccc);
  text2.position.set(0, 8, -50);
  textGroup.add(text2);
  var text3 = dcText("Manche Kugekn kannst du zur Seite bewegen, andere abschießen.", 2, 2, 50, 0x000000, 0xcccccc);
